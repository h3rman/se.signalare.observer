 ...
 */
package se.signalare.observer.net.go
...
import se.signalare.observer.data.AppConfig.Companion.DOH_INDEX
import se.signalare.observer.data.AppConfig.Companion.DOT_INDEX
import se.signalare.observer.data.AppConfig.Companion.FALLBACK_DNS_IF_NET_DNS_EMPTY
import se.signalare.observer.data.AppConfig.TunnelOptions
...
import se.signalare.observer.util.Constants.Companion.RETHINKDNS_DOMAIN
import se.signalare.observer.util.Constants.Companion.RETHINK_BASE_URL_MAX
import se.signalare.observer.util.Constants.Companion.RETHINK_BASE_URL_SKY
...
import se.signalare.observer.util.Utilities.blocklistDir
import se.signalare.observer.util.Utilities.blocklistFile
