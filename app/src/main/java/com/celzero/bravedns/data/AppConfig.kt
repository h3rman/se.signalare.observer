...
import se.signalare.observer.database.DnsCryptEndpointRepository
import se.signalare.observer.database.DnsCryptRelayEndpoint
import se.signalare.observer.database.DnsCryptRelayEndpointRepository
import se.signalare.observer.database.DnsLogRepository
import se.signalare.observer.database.DnsProxyEndpoint
import se.signalare.observer.database.DnsProxyEndpointRepository
import se.signalare.observer.database.DoHEndpoint
import se.signalare.observer.database.DoHEndpointRepository
import se.signalare.observer.database.DoTEndpoint
import se.signalare.observer.database.DoTEndpointRepository
import se.signalare.observer.database.EventSource
import se.signalare.observer.database.EventType
import se.signalare.observer.database.ODoHEndpoint
import se.signalare.observer.database.ODoHEndpointRepository
import se.signalare.observer.database.ProxyEndpoint
import se.signalare.observer.database.ProxyEndpointRepository
import se.signalare.observer.database.RethinkDnsEndpoint
import se.signalare.observer.database.RethinkDnsEndpointRepository
...
import se.signalare.observer.util.InternetProtocol.Companion.getInternetProtocol
