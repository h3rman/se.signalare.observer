...
class FirewallRulesetTest {
    ...
    fun testRuleActions() {
        ...
        assertEquals(se.signalare.observer.R.integer.block, FirewallRuleset.RULE1B.act)
        
        // RULE8 should be an allow rule
        assertEquals(se.signalare.observer.R.integer.allow, FirewallRuleset.RULE8.act)
