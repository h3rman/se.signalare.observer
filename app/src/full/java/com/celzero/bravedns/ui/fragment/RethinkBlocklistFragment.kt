...
import se.signalare.observer.adapter.LocalAdvancedViewAdapter
import se.signalare.observer.adapter.LocalSimpleViewAdapter
import se.signalare.observer.adapter.RemoteAdvancedViewAdapter
import se.signalare.observer.adapter.RemoteSimpleViewAdapter
import se.signalare.observer.customdownloader.LocalBlocklistCoordinator.Companion.CUSTOM_DOWNLOAD
import se.signalare.observer.data.AppConfig
import se.signalare.observer.data.FileTag
import se.signalare.observer.databinding.FragmentRethinkBlocklistBinding
...
import se.signalare.observer.service.RethinkBlocklistManager.RethinkBlocklistType.Companion.getType
import se.signalare.observer.service.RethinkBlocklistManager.getStamp
import se.signalare.observer.service.RethinkBlocklistManager.getTagsFromStamp
import se.signalare.observer.service.VpnController
import se.signalare.observer.ui.activity.ConfigureRethinkBasicActivity.Companion.RETHINK_BLOCKLIST_NAME
import se.signalare.observer.ui.activity.ConfigureRethinkBasicActivity.Companion.RETHINK_BLOCKLIST_TYPE
import se.signalare.observer.ui.activity.ConfigureRethinkBasicActivity.Companion.RETHINK_BLOCKLIST_URL
import se.signalare.observer.ui.bottomsheet.RethinkPlusFilterBottomSheet
import se.signalare.observer.util.Constants
import se.signalare.observer.util.Constants.Companion.DEAD_PACK
import se.signalare.observer.util.Constants.Companion.DEFAULT_RDNS_REMOTE_DNS_NAMES
import se.signalare.observer.util.Constants.Companion.MAX_ENDPOINT
import se.signalare.observer.util.Constants.Companion.RETHINK_STAMP_VERSION
...
import se.signalare.observer.util.Utilities.getRemoteBlocklistStamp
import se.signalare.observer.util.Utilities.hasLocalBlocklists
import se.signalare.observer.util.Utilities.hasRemoteBlocklists
import se.signalare.observer.util.Utilities.showToastUiCentered
import se.signalare.observer.viewmodel.LocalBlocklistPacksMapViewModel
import se.signalare.observer.viewmodel.RemoteBlocklistPacksMapViewModel
import se.signalare.observer.viewmodel.RethinkLocalFileTagViewModel
import se.signalare.observer.viewmodel.RethinkRemoteFileTagViewModel
